    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <h3>{{ auth()->guard('admin')->user()['job']}}</h3>
              ...
              <form action="{{url('admin/updateprofile')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    @if(auth()->guard('admin')->user()['image'] != '')
                    <img src="{{ config('app.url', 'basepath') }}assets/img/users/{{ auth()->guard('admin')->user()['image']}}" alt="Profile">
                    
                    @else
                    <img src="{{ config('app.url', 'basepath') }}assets/img/profile-img.jpg" alt="Profile">
                    
                    @endif
                    <div class="pt-2">
                      <input name="image" type="file" class="form-control" id="iamge" >
                    </div>
                  </div>
                </div>
